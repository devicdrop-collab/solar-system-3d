...
const sunLight = new THREE.PointLight(0xfff5e0, 2.8, 800, 1.2);
...
const sunMat = new THREE.MeshStandardMaterial({
  emissive: 0xfff0a0,
  emissiveMap: loadTex('images/sun.jpg'),
  emissiveIntensity: 1.6,
  map: loadTex('images/sun.jpg')
});
...
// ========== EARTH SHADER ==========
const earthUniforms = {
  dayMap: { value: loadTex('images/earth_daymap.jpg') },
  nightMap: { value: loadTex('images/earth_nightmap.jpg') },
...
// ========== CREATE PLANETS ==========
const mercury = createPlanet({ name: 'Mercury', size: 2.4, distance: 42, tilt: 0.03, map: 'images/mercurymap.jpg', bump: 'images/mercurybump.jpg' });
mercury.spinSpeed = 0.004; mercury.orbitSpeed = 0.0045;

const venus = createPlanet({ name: 'Venus', size: 5.8, distance: 68, tilt: 177.4, map: 'images/venusmap.jpg', bump: 'images/venusbump.jpg', atmosphere: 'images/venus_atmosphere.jpg' });
venus.spinSpeed = 0.0015; venus.orbitSpeed = 0.0018;

const earth = createPlanet({
  name: 'Earth', size: 6.2, distance: 95, tilt: 23.5, map: 'images/earth_daymap.jpg',
  atmosphere: 'images/earth_atmosphere.jpg', customMaterial: earthMaterial,
  moons: [{ size: 1.55, map: 'images/moonmap.jpg', bump: 'images/moonbump.jpg', orbitRadius: 12, orbitSpeed: 0.012 }]
});
earth.spinSpeed = 0.01; earth.orbitSpeed = 0.0012;

const mars = createPlanet({ name: 'Mars', size: 3.5, distance: 125, tilt: 25.2, map: 'images/marsmap.jpg', bump: 'images/marsbump.jpg' });
mars.spinSpeed = 0.0095; mars.orbitSpeed = 0.0009;

const jupiter = createPlanet({
  name: 'Jupiter', size: 17, distance: 210, tilt: 3.1, map: 'images/jupiter.jpg',
  moons: [
    { size: 1.5, map: 'images/jupiterIo.jpg', orbitRadius: 22, orbitSpeed: 0.008 },
    { size: 1.3, map: 'images/jupiterEuropa.jpg', orbitRadius: 27, orbitSpeed: 0.005 },
    { size: 1.9, map: 'images/jupiterGanymede.jpg', orbitRadius: 33, orbitSpeed: 0.003 },
    { size: 1.6, map: 'images/jupiterCallisto.jpg', orbitRadius: 39, orbitSpeed: 0.002 }
  ]
});
jupiter.spinSpeed = 0.02; jupiter.orbitSpeed = 0.0004;

const saturn = createPlanet({
  name: 'Saturn', size: 14.5, distance: 280, tilt: 26.7, map: 'images/saturnmap.jpg',
  ring: { inner: 18, outer: 30, texture: 'images/saturn_ring.png' }
});
saturn.spinSpeed = 0.018; saturn.orbitSpeed = 0.00025;

const uranus = createPlanet({
  name: 'Uranus', size: 7.5, distance: 340, tilt: 97.8, map: 'images/uranus.jpg',
  ring: { inner: 9, outer: 12, texture: 'images/uranus_ring.png' }
});
uranus.spinSpeed = 0.012; uranus.orbitSpeed = 0.00015;

const neptune = createPlanet({ name: 'Neptune', size: 7.2, distance: 385, tilt: 28.3, map: 'images/neptune.jpg' });
neptune.spinSpeed = 0.013; neptune.orbitSpeed = 0.0001;

const pluto = createPlanet({ name: 'Pluto', size: 1.3, distance: 420, tilt: 122.5, map: 'images/plutomap.jpg' });
...
// ========== MARS GLB MOONS ==========
const marsMoonsGLB = [
  { path: 'images/mars/phobos.glb', orbitRadius: 6, orbitSpeed: 0.015, scale: 0.08, angle: 0 },
  { path: 'images/mars/deimos.glb', orbitRadius: 10, orbitSpeed: 0.006, scale: 0.06, angle: 1.5 }
];
...
gltfLoader.load('asteroids/asteroidPack.glb', (gltf) => {
  const meshes = [];
